...
create table team(
  ...
  CONSTRAINT team_accid_fkey FOREIGN KEY (account_id) REFERENCES account(id),
  CONSTRAINT team_leagueid_fkey FOREIGN KEY (league_id) REFERENCES league(league_id)
);
